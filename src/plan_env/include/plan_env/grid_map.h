...
struct MappingParameters
{
  ...
  bool show_occ_time_;
  bool ground_robot_mode_;
  double ground_obstacle_min_height_;
  double ground_obstacle_max_height_;
  double self_clear_radius_;
...
inline Eigen::Vector3i GridMap::getVoxelNum3d() { return mp_.map_voxel_num_; }
