...
3. `READ gitnexus://repo/xxx/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/xxx/context` | Codebase overview, check index freshness |
| `gitnexus://repo/xxx/clusters` | All functional areas |
| `gitnexus://repo/xxx/processes` | All execution flows |
| `gitnexus://repo/xxx/process/{name}` | Step-by-step execution trace |
